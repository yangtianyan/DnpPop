...
// MARK: - Draw helper
public extension DnpPop {
  class func pathWith(rect: CGRect, frame: CGRect, direction: DnpPopDirection, arrowSize: CGSize, arrowPosition: CGPoint, arrowRadius: CGFloat, borderWidth: CGFloat = 0, radius: CGFloat = 0) -> UIBezierPath {
